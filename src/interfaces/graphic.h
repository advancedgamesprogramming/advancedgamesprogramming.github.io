...
/***************************************************************************
    ...
    email                : torcs@free.fr
    version              : $Id: graphic.h,v 1.14.2.2 2013/09/01 10:24:22 berniw Exp $
...
#define GR_PARAM_FILE		"data/config/graph.xml"

#define GR_SOUND_PARM_CFG			"data/config/sound.xml"
