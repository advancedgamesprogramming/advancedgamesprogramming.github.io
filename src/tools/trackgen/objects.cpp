...
InitObjects(tTrack *track, void *TrackHandle)
{
	...
	snprintf(buf, BUFSIZE, ".;data;data/tracks/%s/%s;data/objects", track->category, track->internalname);
	search = strdup(buf);

	snprintf(path, BUFSIZE, "data;data/tracks/%s/%s;data/objects;data/textures;.", track->category, track->internalname);
	ssgTexturePath(path);
	ssgModelPath(path);
...
GenerateObjects(tTrack *track, void *TrackHandle, void *CfgHandle, FILE *save_fd, char *meshFile)
{
	...
	ssgSetCurrentOptions(&options);
	snprintf(buf, BUFSIZE, "data;data/tracks/%s/%s;data/textures;data/img;.", track->category, track->internalname);
	ssgTexturePath(buf);
	snprintf(buf, BUFSIZE, ".;data;data/tracks/%s/%s", track->category, track->internalname);
	ssgModelPath(buf);
	...
	do {
		...
		snprintf(buf, BUFSIZE, "data/tracks/%s/%s/%s", track->category, track->internalname, map);
